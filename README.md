...
## Fork coil-design extensions

This fork retains differentiable coil-design fields, exact planar coils, and their optimization workflows. See [the coil-design guide](docs/planar_coil_design.md). Run its examples from the repository root.
